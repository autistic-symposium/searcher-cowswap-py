...
class OrdersApi(object):
    ...
    def _parse_order_instance(self, input_file) -> None:
        ...
        try:
            ...
            log_error(
                f'Could not load order instance(no amms or orders key): {e}')
                    ...
                    if len(pool) == 3:
                        ...
                        if pool[0] == sell_token:
                            ...
                            data = {
                                ...
                                'sell_reserve': to_decimal_str(
                                    pool_data[sell_token]),
                                'buy_reserve': to_decimal_str(
                                    pool_data[this_buy_token])}
                        ...
                        # Second leg
                            ...
                            log_error(
                                f'Could not extract order data for {pool}.')

                    else:
                        log_error(
                            f'COWSOL has no strategy for 3-legs trade or higher (yet)')
